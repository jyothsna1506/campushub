        ...
        {user?.role?.toUpperCase() === 'ADMIN' && (
          <div className="pt-2">
            <NavLink
              to="/admin"
              onClick={onClose}
              className="flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold text-amber-900 bg-amber-50 hover:bg-amber-100 border border-amber-200 transition-all shadow-2xs"
            >
